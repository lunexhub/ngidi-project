import { Heart, Calendar, Home, Baby, Stethoscope, Droplet, Bandage, Scan } from "lucide-react";
...
const ourServicesData = [
  ...
  },
  {
    icon: Scan,
    title: "Sonar",
    description: "Diagnostic ultrasound imaging to monitor fetal development, confirm pregnancy, and assess maternal health. Available on Saturdays after 12:00."
  }
];
